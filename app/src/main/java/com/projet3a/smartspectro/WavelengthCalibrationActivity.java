...
public class WavelengthCalibrationActivity extends Activity {
    ...
    public WavelengthCalibrationActivity(Handler backgroundHandler) {
    ...
    private void enableListeners() {
        ...
        Button validateButton = findViewById(R.id.validateCalButton);
        ...
        this.Button436.setOnClickListener(view -> {
        ...
        this.Button488.setOnClickListener(view -> {
            if(currentButton != null){
                currentButton.setBackgroundColor(Color.argb(100,187,222,251));
            }
        ...
        this.Button546.setOnClickListener(view -> {
            if(currentButton != null){
                currentButton.setBackgroundColor(Color.argb(100,187,222,251));
            }
        ...
        this.Button612.setOnClickListener(view -> {
            if(currentButton != null){
                currentButton.setBackgroundColor(Color.argb(100,187,222,251));
            }
        ...
        try{
            ...
            this.cameraDevice.createCaptureSession(Collections.singletonList(surface), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(@NotNull CameraCaptureSession captureSession) {
                    Toast.makeText(com.projet3a.smartspectro.WavelengthCalibrationActivity.this, "Configuration change", Toast.LENGTH_SHORT).show();
                }
            },null);
        }catch(CameraAccessException e){
            e.printStackTrace();
